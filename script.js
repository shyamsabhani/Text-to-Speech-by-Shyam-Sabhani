...
const vSpeed = document.querySelector('#voiceSpeed');
const vSpeedValue = document.querySelector('#speedValue');

const voicesSelect = document.querySelector('#voices'); // Select element for voices

// Web Speech API
const speech = new SpeechSynthesisUtterance();
speech.rate = vSpeed.value;
vSpeedValue.innerHTML = vSpeed.value;
...
vSpeed.addEventListener('change', () => {
  speech.rate = vSpeed.value;
  console.log(vSpeed.value);
  vSpeedValue.innerHTML = vSpeed.value;
});
